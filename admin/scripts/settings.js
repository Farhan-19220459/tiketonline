...
{
    let contacts_p_id = ['address', 'gmaps', 'telp1', 'telp2', 'email', 'facebook', 'instagram', 'twitter'];
...
{
    let contacts_inp_id = ['address', 'gmaps', 'telp1', 'telp2', 'email', 'facebook', 'instagram', 'twitter'];
...
{
    let index = ['address', 'gmaps', 'telp1', 'telp2', 'email', 'facebook', 'instagram', 'twitter'];
    let contacts_inp_id = ['address_inp', 'gmaps_inp', 'telp1_inp', 'telp2_inp', 'email_inp', 'facebook_inp', 'instagram_inp', 'twitter_inp']
